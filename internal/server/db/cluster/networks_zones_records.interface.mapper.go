...
type NetworkZoneRecordGenerated interface {
	...
	GetNetworkZoneRecord(ctx context.Context, db dbtx, name string) (*NetworkZoneRecord, error)

	// GetNetworkZoneRecordNames returns the identifying field of NetworkZoneRecord.
	// generator: NetworkZoneRecord GetNames-by-NetworkZoneID
	GetNetworkZoneRecordNames(ctx context.Context, db dbtx, filters ...NetworkZoneRecordFilter) ([]string, error)

	// NetworkZoneRecordExists checks if a NetworkZoneRecord with the given key exists.
	// generator: NetworkZoneRecord Exists
	NetworkZoneRecordExists(ctx context.Context, db dbtx, name string) (bool, error)
	...
	GetNetworkZoneRecordID(ctx context.Context, db tx, name string) (int64, error)
	...
	RenameNetworkZoneRecord(ctx context.Context, db dbtx, name string, to string) error
	...
	// generator: NetworkZoneRecord Update
	UpdateNetworkZoneRecord(ctx context.Context, db tx, name string, object NetworkZoneRecord) error
